...
<body id="advlink" style="display: none">
    <form onsubmit="insertAction();return false;" action="#" name="linkform" id="linkform">
		<div class="tabs">
			<ul>
				...
				<li id="internal_tab"><span><a href="javascript:mcTabs.displayTab('internal_tab','internal_panel');" onmousedown="return false;">{#advlink_dlg.internal_tab}</a></span></li>
		...
		<div class="panel_wrapper">
			...
			<div id="internal_panel" class="panel">
				<fieldset>
					<legend>{#advlink_dlg.internal_props}</legend>
					
						  
					<iframe border="0" src="/admin/index.php?a=cms&c=page:popupSelector&page_id=<?php echo $_GET['page_id'] ?>" width="400" heigth="400"></iframe>
				</fieldset>
			</div>
