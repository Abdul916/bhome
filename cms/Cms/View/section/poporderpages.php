...
<div id="modalcontent" class="">
	...
	<div id="list">
		<iframe src ="<?php Core_Common_Route::linkController('section:orderPagesFrame', array('section_id' => $currentparent->get('id'), 'site_id' => $site->get('id'))); ?>" 
			width="555" height="450" frameborder="0" id="content" name="content">
