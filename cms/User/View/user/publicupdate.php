		...
		<div id="main-content">
			<div class="container">
				<div id="login-window" class="window">
                    ...
                    ?>
					<form id="login" action="<?php Core_Common_Route::linkController('user:updated') ?>" method="post" accept-charset="utf-8">
						...
						<input type="hidden" name="user_id" value="<?php echo $registro->get('id'); ?>" id="credential_id">
					</form>	
					<!-- 
					<div class="inner">
