...
<?php
$projects = $this->factory('page');
$projects->select()->where('page_structure_id = 15 and publish_status = 1')->orderBy('orden asc')->runSelect();
?>
<body>
...
<div class="container">
   ...
   <div class="caja">
		<div class="navigation">
			 <h1>Projects</h1>
			 <!--<ul class="subnav"><li><a class="active" href="#">All</a></li></ul> -->
		</div>	 
			 <div id="under" class="projects mt-100">
       <?php foreach ($projects as $p) :
                $project = new FrontCms_Core_Page( $p);
         ?>
				<div class="project">
                <a href="<?php echo $project->getUrl(); ?>"><img src="/<?= $project->get('home-photo')->get('file_path') ?>" alt="">
                <p><?= $project->get('page-name'); ?></p><span><?= $project->get('status'); ?></span></a>
				</div>
		<?php endforeach; ?>	
			 </div>
			 
             <h5><?= $page->get('tagline'); ?></h5>
